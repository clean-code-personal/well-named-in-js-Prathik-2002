...
export class Manual extends EvenCountColorCode{
    MANUAL= {
            "Title": "25-pair color code",
            "definition": "The 25-pair color code, originally known as even-count color code, is a color code used to identify individual conductors in twisted-pair wiring for telecommunications",
